    ...
    <div class="form">
      ...
      >
        ...
        <el-form-item v-if="form.type == '从数据库添加'" label="元件配图:">
          <el-button @click="showImage = true">查看元件配图</el-button>
          <el-dialog title="元件配图" :visible.sync="showImage" width="30%">
            <img :src="src" alt="网络拥堵,图片未加载成功!" />
        ...
        <el-form-item v-if="form.type == '添加新元件'" label="元件配图:">
          <el-upload
            class="upload-demo"
            drag
            action="https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg"
            multiple
          >
...
export default {
  ...
  data() {
    return {
      ...
      src:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEEk8o1KlDrRdC6t4iRAppiH9IjpawIYKdSA&usqp=CAU",
